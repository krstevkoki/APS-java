...
public class OpenBucketHashTableTest {
    public static void main(String[] args) {
        OpenBucketHashTable<ChemicalElement, Integer> table1 = new OpenBucketHashTable<>(26);
        ...
        OpenBucketHashTable<ChemicalElement, Integer> table2 = table1.clone();
